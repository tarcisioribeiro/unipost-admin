    ...
    def display() -> Dict[str, Any]:
        ...
        with st.form("text_generation_form"):
            ...
            form_data['text_type'] = st.selectbox(
                "Tipo de texto",
                options=["Post para redes sociais", "Artigo", "Notícia", "Email"],
                index=0
            )
            ...
            form_data['audience'] = st.selectbox(
                "Público-alvo",
                options=["Geral", "Acadêmico", "Profissional", "Jovem", "Técnico"],
                index=0
            )
            ...
            form_data['tone'] = st.selectbox(
                "Tom",
                options=["Formal", "Informal", "Persuasivo", "Informativo", "Criativo"],
                index=0
            )
